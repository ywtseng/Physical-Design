...
public:
    ...
    void outputPdfFigure(string filePathName);
    void outputPngFigure(string filePathName);
    ...
    double boundaryTop() {return _boundaryTop;}
    double boundaryLeft() {return _boundaryLeft;}
    double boundaryBottom() {return _boundaryBottom;}
    double boundaryRight() {return _boundaryRight;}
